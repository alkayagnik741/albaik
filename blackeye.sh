#!/bin/bash
# ALBAIK v1.0 is an upgrade from original ShellPhish Tool (https://github.com/thelinuxchoice/shellphish) by thelinuxchoice under GNU LICENSE 
...
printf "     \e[101m\e[1;77m:: responsible for any misuse or damage caused by ALBAIK.  ::\e[0m\n"
printf "     \e[101m\e[1;77m:: Only use for educational purporses!!                      ::\e[0m\n"
printf "\n"
printf "     \e[101m\e[1;77m::     ALBAIK v1.5! By @suljot_gjoka & @thelinuxchoice     ::\e[0m\n"
printf "\n"
}
